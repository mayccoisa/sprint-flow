export const en = {
    translation: {
        ...
        settings: {
            ...
            setPasswordDesc: "Your account signs in with Google. Create a password to also sign in with email and password.",
            changePasswordDesc: "Set a new password for your account.",
            newPassword: "New password",
            confirmPassword: "Confirm password",
            pwdTooShortTitle: "Password too short",
            pwdTooShortDesc: "Password must be at least 6 characters.",
            pwdMismatchTitle: "Passwords don't match",
            pwdMismatchDesc: "Type the same password in both fields.",
            pwdCreatedTitle: "Password created",
            pwdUpdatedTitle: "Password updated",
            pwdSavedDesc: "You can now sign in with email and password on any device.",
            pwdErrorTitle: "Couldn't save the password",
            reauthCancelled: "Re-authentication cancelled. Please try again.",
        },
        validation: {
            required: "Required",
        ...
        login: {
            ...
            signInHere: "Sign in",
            forgotPassword: "Forgot / set my password",
            enterEmailFirst: "Enter your email",
            enterEmailFirstDesc: "Type your email in the field above to receive the password link.",
            resetSentTitle: "Email sent",
            resetSentDesc: "We sent you a link to set your password. Check your inbox (and spam folder)."
        },
        dashboard: {
            title: "Dashboard",
